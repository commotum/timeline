...
New York University woj.zaremba@gmail.com
...
$$\begin{pmatrix} i \\ f \\ o \\ g \end{pmatrix} = \begin{pmatrix} \operatorname{sigm} \\ \operatorname{sigm} \\ \operatorname{sigm} \\ \tanh \end{pmatrix} T_{2n,4n} \begin{pmatrix} \mathbf{D}(h_t^{l-1}) \\ h_{t-1}^{l} \end{pmatrix}$$
...
<sup>†</sup>http://www.fit.vutbr.cz/~imikolov/rnnlm/simple-examples.tgz
