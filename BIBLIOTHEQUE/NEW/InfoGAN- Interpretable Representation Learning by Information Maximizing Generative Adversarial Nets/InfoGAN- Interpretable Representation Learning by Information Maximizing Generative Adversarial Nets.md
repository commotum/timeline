...
Xi Chen<sup>†‡</sup>, Yan Duan<sup>†‡</sup>, Rein Houthooft<sup>†‡</sup>, John Schulman<sup>†‡</sup>, Ilya Sutskever<sup>‡</sup>, Pieter Abbeel<sup>†‡</sup>
...
| [24] | I. T. Smin contains "Hasymonical and comic synamical learning with established consenting education                                                              |
|------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [34] | J. T. Springenberg, "Unsupervised and semi-supervised learning with categorical generative adversarial networks," <i>ArXiv preprint arXiv:1511.06390</i> , 2015. |
|      |                                                                                                                                                                  |
|      |                                                                                                                                                                  |
|      |                                                                                                                                                                  |
|      |                                                                                                                                                                  |
...
| FC.128-batchnorm-lRELU-FC.output for $Q$          | $4 \times 4$ upconv. 1 channel                      |
...
| $4 \times 4$ conv. 256 IRELU. stride 2. batchnorm | $4 \times 4$ upconv. 128 RELU. stride 2.           |
| FC. output layer for $D$ ,                        |                                                    |
...
| Wide or Narrow | ide or Narrow learned using the same network as the lighting variation |                     |     |
...
| discriminator $D$ / recognition network $Q$       | generator $G$                                      |
|---------------------------------------------------|----------------------------------------------------|
| Input 64 × 64 Gray image                          | $Input \in \mathbb{R}^{189}$                       |
| $4 \times 4$ conv. 64 lRELU. stride 2             | FC. 1024 RELU. batchnorm                           |
| $4 \times 4$ conv. 128 IRELU. stride 2. batchnorm | FC. $8 \times 8 \times 256$ RELU. batchnorm        |
| $4 \times 4$ conv. 256 lRELU. stride 2. batchnorm | $4 \times 4$ upconv. 256 RELU. batchnorm           |
| $4 \times 4$ conv. 256 IRELU. batchnorm           | $4 \times 4$ upconv. 256 RELU. batchnorm           |
| $4 \times 4$ conv. 256 IRELU. batchnorm           | $4 \times 4$ upconv. 128 RELU. stride 2. batchnorm |
| FC. 1024 IRELU. batchnorm                         | $4 \times 4$ upconv. 64 RELU. stride 2. batchnorm  |
| FC. output layer                                  | $4 \times 4$ upconv. 1 sigmoid.                    |
...
|          | Learning rate for $D / Q$ | Learning rate for G | $\lambda_{ m cont}$ | $\lambda_{ m disc}$ |
|----------|---------------------------|---------------------|---------------------|---------------------|
