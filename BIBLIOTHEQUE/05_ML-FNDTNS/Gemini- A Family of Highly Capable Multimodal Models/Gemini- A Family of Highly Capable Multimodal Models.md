...
<sup>&</sup>lt;sup>1</sup>See Contributions and Acknowledgments section for full author list. Please send correspondence to gemini-1-report@google.com
...
<sup>&</sup>lt;sup>2</sup>We define goodput as the time spent computing useful new steps over the elapsed time of the training job.
...
<sup>&</sup>lt;sup>3</sup>See demos on website https://deepmind.google/gemini.
...
| MATH Math problems across 5 difficulty levels &                                                               | <b>53.2%</b> 4-shot               | 32.6%<br>4-shot             | 52.9%<br>4-shot<br>(via API**)   | 34.1%<br>4-shot<br>(via API**) | 34.4%<br>4-shot           | _                   | 34.8%             | 23.9%<br>4-shot            | 13.5%<br>4-shot |
| 7 subdisciplines<br>(Hendrycks et al., 2021b)                                                                 |                                   |                             | 50.3%<br>(Zheng et al.,<br>2023) |                                |                           |                     |                   |                            |                 |
| BIG-Bench-Hard<br>Subset of hard BIG-bench<br>tasks written as CoT prob-<br>lems<br>(Srivastava et al., 2022) | <b>83.6%</b><br>3-shot            | 75.0%<br>3-shot             | 83.1%<br>3-shot<br>(via API**)   | 66.6%<br>3-shot<br>(via API**) | 77.7%<br>3-shot           | _                   | _                 | _                          | 51.2%<br>3-shot |
| HumanEval<br>Python coding tasks<br>(Chen et al., 2021)                                                       | <b>74.4%</b> 0-shot (PT****)      | 67.7%<br>0-shot<br>(PT****) | 67.0%<br>0-shot<br>(reported)    | 48.1%<br>0-shot                | _                         | 70.0%<br>0-shot     | 44.5%<br>0-shot   | 63.2%<br><sub>0-shot</sub> | 29.9%<br>0-shot |
...
| XLsum (3-shot) | 17.6         | 16.2       | _     | 15.4     |
| Wikilingua     | 48.9         | 47.8       | _     | 50.4     |
...
|                                                    | Factuality<br>(Inaccurate Rate) | Attribution<br>(AIS)        | Hedging<br>(Accuracy) |  |
|----------------------------------------------------|---------------------------------|-----------------------------|-----------------------|--|
| Gemini API Pro<br>No factuality-focused adaptation | 6.7%<br>[5.8%, 7.8%]            | <b>40.2%</b> [37.9%, 42.5%] | 0%                    |  |
| Gemini API Pro<br>Final stage of post-training     | 3.8%<br>[3.1%, 4.8%]            | 60.0%<br>[57.6%, 62.1%]     | 69.3%                 |  |
...
|-------------------------------------------------------------------------|---------------------------------|-------------------------------|----------------------------------|----------------------------------|-----------------------|----------------------------------------------------------|
| MMMU (val) Multi-discipline college-level problems (Yue et al., 2023)   | <b>59.4%</b> pass@1             | 47.9%                         | 32.6%                            | 26.3%                            | 56.8%                 | 56.8%<br>GPT-4V, 0-shot                                  |
| (Tue et al., 2023)                                                      | <b>62.4%</b><br>Maj1@32         |                               |                                  |                                  |                       |                                                          |
| TextVQA (val) Text reading on natural images (Singh et al., 2019)       | 82.3%                           | 74.6%                         | 65.9%                            | 62.5%                            | 78.0%                 | 79.5%<br>Google PaLI-3, fine-tuned                       |
| DocVQA (test) Document understanding (Mathew et al., 2021)              | 90.9%                           | 88.1%                         | 74.3%                            | 72.2%                            | 88.4% (pixel only)    | 88.4%<br>GPT-4V, 0-shot                                  |
| ChartQA (test) Chart understanding (Masry et al., 2022)                 | 80.8%                           | 74.1%                         | 51.9%                            | 53.6%                            | 78.5%<br>(4-shot CoT) | 79.3%<br>Google DePlot, 1-shot PoT<br>(Liu et al., 2023) |
| InfographicVQA (test) Infographic understanding (Mathew et al., 2022)   | 80.3%                           | 75.2%                         | 54.5%                            | 51.1%                            | 75.1% (pixel only)    | 75.1%<br>GPT-4V, 0-shot                                  |
...
| Business                    | <b>62.7</b>           | 56.7   | 59.3            |
| Science                     | 49.3                  | 48.0   | <b>54.7</b>     |
...
<sup>&</sup>lt;sup>5</sup>MathVista is a comprehensive mathematical reasoning benchmark consisting of 28 previously published multimodal datasets and three newly created datasets. Our MathVista results were obtained by running the MathVista authors' evaluation script.
...
| Automatic Speech<br>Translation | CoVoST 2<br>(21 lang)<br>(Wang et al., 2020)                    | BLEU (1) | 40.1          | 35.4             | 29.1<br>(v2)                                          | 30.7                           |
...
|--------|------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|-------------|
| Fleurs | Scotturb bus 403 travels regularly to Sintra, stopping at Cabo da Roca.                                                            | Scotboard bus four3 traversed regularly to Centra stopping at Cabo de Roga.                                       | Scotturb bus 403 travels regularly to Sintra, stopping at Cabo da Roca.                                                            | <b>=</b> )) |
| Fleurs | The archipelago lies 120 km north of the Peninsula. The largest is King George Island, with the settlement of Villa Las Estrellas. | The archipelago lines 120 km north of peninsula. The largest is Kingurch island with the settlement of Cua Losas. | The archipelago lies 120 km north of the Peninsula. The largest is King George Island, with the settlement of Villa Las Estrellas. | <b> </b>    |

Table  $12 \mid$  Qualitative examples for the ASR task in the benchmark. Incorrect transcriptions are highlighted in red.
...
Input Audio (transcribed) Input Image Model Response: Text What's the first step to make a veggie omelet Crack the eggs into a bowl and whisk them. with these ingredients? Thank you for the instructions. I started mak-It looks like it's almost ready. You can flip it over ing my omelet, does it look ready now? to cook the other side. (No image - it's a follow up Why is it not ready? It's not ready because the eggs are still runny. on the previous question) What about now? It looks ready now. You can take it off the heat and serve it.
...
|                                 |                              |                                     | Factuality & Knowledge<br>Retrieval |                                     |
|---------------------------------|------------------------------|-------------------------------------|-------------------------------------|-------------------------------------|
|                                 | GSM8K<br>Cobbe et al. (2021) | MATH<br>Hendrycks et al.<br>(2021b) | NQ<br>Kwiatkowski et al.<br>(2019b) | Realtime QA<br>Kasai et al. (2022a) |
...
| Language | Quality<br>SxS | Coding<br>MBPP Pass@1<br>Austin et al. (2021) | Reasoning<br>MMLU<br>Hendrycks et al.<br>(2021a) |
|----------|----------------|-----------------------------------------------|--------------------------------------------------|
| ja-JP    | +0.14          | +22.2%                                        | +3.6%                                            |
| pt-BR    | +0.17          | +23.2%                                        | +5.2%                                            |
| de-DE    | +0.1           | +21.4%                                        | +7.5%                                            |
...
|-----------------------------------------------------------------------------|------------------------------------------------------------|--------------------------------------------|-----------------------------------------------------|
| MMMU (val) Multi-discipline college-level problems                          | n/a                                                        | 59.4%<br>pass@1                            | n/a                                                 |
...
<sup>&</sup>lt;sup>6</sup>A sociotechnical approach is anchored in the observation that AI systems are sociotechnical systems: both humans and technological artifacts are necessary in order to make the technology work as intended (Selbst et al., 2019).
...
- Alec Radford, Jeffrey Wu, Rewon Child, David Luan, Dario Amodei, and Ilya Sutskever. Language models are unsupervised multitask learners
Christina Sorokin Chris Alberti Chu-Cheng Lin

Colin Evans Alek Dimitriev Hannah Forbes Dylan Banarse

Zora Tung Mark Omernick Colton Bishop Rachel Sterneck

Rohan Jain Jiawei Xia Ehsan Amid
...
James Lee-Thorp Christopher Yew Danila Sinopalnikov Sabela Ramos **Contributors** 
...
Rupert Kemp Sushant Kafle Tanya Grunina Rishika Sinha Alice Talbert Diane Wu
...
Saaber Fatehi John Wieting Omar Ajmeri Benigno Uria Contributors
Yeongil Ko
Laura Knight
Amélie Héliou

Ning Niu Shane Gu Chenxi Pang
...
Pouya Tafti Zhiyu Liu Anmol Gulati

Jasmine Liu Xinyu Ye Bart Chrzaszcz Lily Wang Nikhil Sethi

Tianrun Li Ben Brown Shreya Singh Wei Fan Aaron Parisi

Joe Stanton Vinod Koverkathu
...
David Bridson Dario de Cesare Tom Hudson
...
Dominik Grewe Anastasia Petrushkina Tom Duerig

Antonio Sanchez Steve Yadlowsky Amy Shen Amir Globerson Lynette Webb ContributorsContributorsSahil DuaJason GelmanDong LiYang Xu
...
Brennan Saeta Yuan Tian Tyler Liechty Anand Iyer
...
Nidhi Vyas Chrisantha Fernando Martin Wicke Ken Durden
...
Nilesh Tripuraneni Dinghua Li Blake Hechtman David Madras Mandy Guo Parker Schuh Milad Nasr **Austin Waters** Kieran Milan Oliver Wang Joshua Ainslie Vladimir Mikulik Jason Baldridge Juliana Franco Han Zhang Tim Green

Garima Pruthi Nam Nguyen Jakob Bauer Joe Kelley
...
Harshal Godhia Uli Sachs Anthony Chen Yicheng Fan
...
Mathias Carlen Jan van de Kerkhof

Marcin Pikus Krunoslav Zaher Paul Müller Sasha Zykova Richard Stefanec
...
Keshav Dhandhania Manish Katyal Akshay Gupta Atharva Parulekar Divya Pitta

Divya Pitta Jing Zhao Vivaan Bhatia Yashodha Bhavnani Omar Alhadlaq Xiaolin Li

Peter Danenberg Dennis Tu Alex Pine Vera Filippova Abhipso Ghosh Ben Limonchik
...
Trevor Strohman<sup>9</sup> Yonghui Wu<sup>10</sup>
...
<sup>&</sup>lt;sup>7</sup>Lead, Gemini App Engineering

<sup>&</sup>lt;sup>8</sup>Lead, Gemini App Core Modeling, Eval, Data

<sup>&</sup>lt;sup>9</sup>Co-Lead, Gemini App Serving

<sup>&</sup>lt;sup>10</sup>Co-Lead, Gemini Text
...
| Input(s)           | Text (e.g. a question, a prompt, a document(s) to be summ rized), images, video, audio files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |  |
| Output(s)          | Generated text in response to the input (e.g. an answer the question, a summary of multiple documents, comparind documents/videos).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |  |
|                    | Usage                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |  |
...
| <b>Compute Requirements</b> | Not reported.                                                                                                                                                                                                                                                                   |  |  |  |
...
| <b>Evaluation Results</b>      | See Section 5 (Evaluation) and Section 6.4 (Post-Training Human Evaluation).                                                                                                                                                                                                                                                                                                                                                                                                |
...
| Ethical Considerations & Risks | A reflection on the potential risks and impacts of the Gemini V1.0 models can be found in Section 7 (Responsible Deployment). For evaluation details for a range of risks, see Section 7.4 (Safety Evaluations).                                                                                                                                                                                                                                                            |
...
55
56
            <mg sre="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Didelphis_virginiana.jpg/1200px-Didelphis_virginiana.jpg" alt="Opossum" width="100">
