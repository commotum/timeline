...
<sup>&</sup>lt;sup>2</sup>See for example the case of Hellaswag.
...
<sup>&</sup>lt;sup>3</sup>https://huggingface.co/blog/evaluating-mmlu-leaderboard

<sup>&</sup>lt;sup>4</sup>As defined in https://www.alignmentforum.org/posts/BoA3agdkAzL6HQtQP/clarifying-and-predicting-agi, a t-AGI beats, on most tasks, most human experts who are given time t to perform the task
...
FINAL ANSWER: \$89706.00 Ground truth:  $89706.00 \checkmark$ 
...
Results. Our evaluation can be found in Figure 4, with more details in Table 4 (Appendix D.1). Our proposed levels of difficulty, loosely defined in terms of number of steps and number of different capabilities used, are correlated with the performance of current models, strengthening their validity. While humans excel at all levels, current best LLMs do poorly. Overall, GAIA allows to clearly rank capable assistants, while leaving a lot of room for improvement in the coming months and perhaps years.
 ...
 $<sup>^{6} \</sup>verb|https://openai.com/blog/chatgpt-plugins|$ 

<sup>&</sup>lt;sup>7</sup>https://github.com/Significant-Gravitas/Auto-GPT, git hash of the AutoGPT version evaluated: ed172dec1947466cc0942abf75bb77b027cd433d.
...
- Markus Jakobsson and Ari Juels. *Proofs of Work and Bread Pudding Protocols(Extended Abstract)*, pages 258–272. Springer US, Boston, MA, 1999. ISBN 978-0-387-35568-9. doi: 10.1007/978-0-387-35568-9\_18. URL https://doi.org/10.1007/978-0-387-35568-9\_18.
...
Figure 7 Using multiple tools does not necessarily involve Figure 8 Unsurprisingly, the number of steps taken to more time to answer a question.
...
| File            | None                                                                                                                                                                                                                                                                                                                                                                                                                                    |  |  |  |  |  |  |
| Level           | 1                                                                                                                                                                                                                                                                                                                                                                                                                                       |  |  |  |  |  |  |
| Steps           | <ul> <li>Searched "nih" on Google search.</li> <li>Clicked the top link to nih.gov.</li> <li>Searched "h pylori acne" in the search box.</li> <li>Clicked "More" and selected "Clinical Trials".</li> <li>Clicked the result about H. Pylori and acne.</li> <li>Checked the date to confirm it was January to May 2018.</li> <li>Opened "Tabular View".</li> <li>Scrolled down to Actual Enrollment and recorded the number.</li> </ul> |  |  |  |  |  |  |
| Number of steps | 8                                                                                                                                                                                                                                                                                                                                                                                                                                       |  |  |  |  |  |  |
| Answer          | 90                                                                                                                                                                                                                                                                                                                                                                                                                                      |  |  |  |  |  |  |
...
| Number of tools | 1                                                                                                                                                                                                                                                                                                                                                                                                                                       |  |  |  |  |  |  |
 ...
 $\textbf{Table 1} \ \ \text{An annotated question during the question creation phase}.$ 
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
| Two new annotators agree with original answer One new annotator agree with original answer, other disagree Two new annotators disagree with original answer | 55%<br>27%<br>18% |
| Valid questions (aggregated)*                                                                                                                               | 68%               |
| Valid Level 1 questions Valid Level 2 questions Valid Level 3 questions                                                                                     | 75%<br>68%<br>47% |
| Human score (aggregated)**                                                                                                                                  | 92%               |
| Human score for Level 1 Human score for Level 2 Human score for Level 3                                                                                     | 94%<br>92%<br>87% |
...
| Metric                                                 |                                            | Score in % (†)                               |                  |                             | Avg. time to answer in mins $(\downarrow)$ |                              |  |
|--------------------------------------------------------|--------------------------------------------|----------------------------------------------|------------------|-----------------------------|--------------------------------------------|------------------------------|--|
| Level                                                  | Level 1                                    | Level 2                                      | Level 3          | Level 1                     | Level 2                                    | Level 3                      |  |
| Number of questions                                    | 146                                        | 245                                          | 75               | 146                         | 245                                        | 75                           |  |
| GPT4 GPT4 Turbo AutoGPT (GPT4 backend) GPT4 + plugins* | $9.1 \pm 2.5$ $13.0 \pm 2.1$ $14.4$ $30.3$ | $2.6 \pm 0.6$<br>$5.5 \pm 1.4$<br>0.4<br>9.7 | 0<br>0<br>0<br>0 | 0.19<br>0.24<br>7.6<br>0.65 | 0.15<br>0.12<br>11.7<br>0.53               | N.A.<br>N.A.<br>N.A.<br>N.A. |  |
| Search engine<br>Human annotator**                     | 7.4<br>93.9                                | 0<br>91.8                                    | 0<br>87.3        | 7.4<br>6.8                  | N.A.<br>10.5                               | N.A.<br>17.7                 |  |
...
FINAL ANSWER: Unable to provide Ground truth: Saint Petersburg X
...
FINAL ANSWER: Saint Petersburg Ground truth: Saint Petersburg V
...
FINAL ANSWER: Orange, White Ground truth: orange, white  $\sqrt{\phantom{a}}$ 
...
Orange: FrontRed: BackBlue: LeftGreen: RightWhite: Up

# Yellow: DownStep-by-Step Analysis:
