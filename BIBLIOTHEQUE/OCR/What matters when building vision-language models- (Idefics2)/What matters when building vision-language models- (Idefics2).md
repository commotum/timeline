...
Hugo Laurençon\*,1,2 Léo Tronchon\*,1 Matthieu Cord<sup>2</sup> Victor Sanh<sup>1</sup>
...
#### **Prompt** Idefics2 output For 2024, the interest expense is twice what it Yes, I can help you calculate that. First, let's find out was in 2014, and the long-term debt is 10% the interest expense for 2024: higher than its 2015 level. Can you calculate the Interest Expense (2024) = 2 \* Interest Expense (2014) combined total of the interest and long-term debt = 2 \* 630 for 2024? = 1260 2014 Next, let's find the long-term debt for 2024: Long-Term Debt (2024) = Long-Term Debt (2015) + Sales \$ 9,402 \$10,091 10% of Long-Term Debt (2015) Depreciation 1,350 1,351 = 19,260 + 0.1 \* 19,260 Cost of goods sold 3,235 3,672 = 19,260 + 1,926 Other expenses 767 641 = 21,186 Interest 630 724 Now, we can add these two amounts together to get Cash 4,931 6,244 the combined total of the interest and long-term debt Accounts receivable 6,527 7,352 for 2024: Short-term notes payable 953 895 Combined Total (2024) = Interest Expense (2024) + Long-term debt 16,152 19,260 Long-Term Debt (2024) Net fixed assets 41,346 42,332 = 1260 + 21,186 5,179 Accounts payable 5.022 = 22,446 11,926 Inventory 11,604 So, the combined total of the interest and long-term Dividends 1,147 1,261 debt for 2024 is \$22,446.
...
(60.1% on MMLU) yields a boost of 5.1 (see Table 1). Additionally, switching the vision encoder from CLIP-ViT-H (Radford et al., 2021) (78.0% on ImageNet(Deng et al., 2009)) to SigLIP-SO400M
...
guage model layers, and the higher the vision-language performance. As such, we note that under this setup, the cross-attention architecture has 1.3B more trainable parameters (2B trainable parameters in total) than the fully autoregressive architecture. Additionally, at inference time, the former uses 10% more flops than the latter. Under these conditions, we observe that the cross-attention architecture performs 7 points better in Table 3.
...
<sup>&</sup>lt;sup>2</sup>Since SigLIP is trained with a fixed resolution, the positional embeddings can be interpreted both as absolute or relative positions. With the aspect ratio and resolution preserving, these positions become relative positional embeddings.
...
Table 7: Ablation on the synergy between OCR data and image resolution. We pre-trained the models for 5'500 steps, followed by 500 steps of fine-tuning on DocVOA.

formance on benchmarks that require reading text without decreasing the performance on other benchmarks (see Table 7).
...
<sup>4</sup>https://laion.ai/blog/laion-coco/

<sup>5</sup>https://github.com/LAION-AI/LAION-SAFETY

<sup>6</sup>https://huggingface.co/datasets/pixparse/pdfa-eng-wds
...
<sup>8</sup>https://huggingface.co/datasets/HuggingFaceM4/the\_cauldron
...
Table 9: Performance of Idefics2 against state-of-the-art VLMs up to a size of 14B parameters. The evaluations are done in zero shot. Idefics2 with 64 or 320 tokens per image is the same model (same weights), only the inference differs. The full table is present in Appendix A.3.2. (Benchmark, Split, Metric): (MMMU, val/test, MMMU score), (MathVista, testmini, MMMU score),
...
- Carbune, V., H. Mansoor, F. Liu, R. Aralikatte, G. Baechler, J. Chen, and A. Sharma (2024). Chart-based reasoning: Transferring capabilities from llms to vlms.
...
- Huang, S., L. Dong, W. Wang, Y. Hao, S. Singhal, S. Ma, T. Lv, L. Cui, O. K. Mohammed, B. Patra,
  ...
  Language is not all you need: Aligning perception with language models. In *Thirty-seventh Conference on Neural Information Processing Systems*.
...
- Laurençon, H., L. Saulnier, T. Wang, C. Akiki, A. Villanova del Moral, T. Le Scao, L. Von Werra,
  C. Mou, E. González Ponferrada, H. Nguyen, J. Frohberg, M. Šaško, Q. Lhoest, A. McMillan-Major, G. Dupont, S. Biderman, A. Rogers, L. Ben allal, F. De Toni, G. Pistilli, O. Nguyen,
  S. Nikpoor, M. Masoud, P. Colombo, J. de la Rosa, P. Villegas, T. Thrush, S. Longpre, S. Nagel,
  L. Weber, M. Muñoz, J. Zhu, D. Van Strien, Z. Alyafeai, K. Almubarak, M. C. Vu, I. Gonzalez-Dios, A. Soroa, K. Lo, M. Dey, P. Ortiz Suarez, A. Gokaslan, S. Bose, D. Adelani, L. Phan, H. Tran,
...
- Li, L., Y. Yin, S. Li, L. Chen, P. Wang, S. Ren, M. Li, Y. Yang, J. Xu, X. Sun, L. Kong, and Q. Liu (2023). M<sup>3</sup>it: A large-scale dataset towards multi-modal multilingual instruction tuning.
...
- Lu, P., S. Mishra, T. Xia, L. Qiu, K.-W. Chang, S.-C. Zhu, O. Tafjord, P. Clark, and A. Kalyan (2022).
  Learn to explain: Multimodal reasoning via thought chains for science question answering. In S. Koyejo, S. Mohamed, A. Agarwal, D. Belgrave, K. Cho, and A. Oh (Eds.), *Advances in Neural Information Processing Systems*, Volume 35, pp. 2507–2521. Curran Associates, Inc.
...
| OCR, document understanding, text tre | anscription |             |            |           |
| RenderedText <sup>9</sup>             | 999,000     | 999,000     | 27,207,774 | 5.57%     |
| DocVQA (Mathew et al., 2021)          | 10,189      | 39,463      | 337,829    | 3.46%     |

 $<sup>^9 \</sup>mathtt{https://huggingface.co/datasets/wendlerc/RenderedText}$ 

| TextCaps (Sidorov et al., 2020) TextVQA (Singh et al., 2019) ST-VQA (Biten et al., 2019) OCR-VQA (Mishra et al., 2019) VisualMRC (Tanaka et al., 2021) IAM (Marti and Bunke, 2002) InfoVQA (Mathew et al., 2022) Diagram image-to-text <sup>10</sup> | 21,953                    | 21,953                                                                | 389,658                                                                 | 2.00%                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|-----------------------------------------------------------------------|-------------------------------------------------------------------------|--------------------------------------------|
|                                                                                                                                                                                                                                                      | 21,953                    | 34,602                                                                | 181,918                                                                 | 1.86%                                      |
|                                                                                                                                                                                                                                                      | 17,247                    | 23,121                                                                | 127,846                                                                 | 1.31%                                      |
|                                                                                                                                                                                                                                                      | 165,746                   | 801,579                                                               | 6,073,824                                                               | 0.93%                                      |
|                                                                                                                                                                                                                                                      | 3,027                     | 11,988                                                                | 168,828                                                                 | 0.86%                                      |
|                                                                                                                                                                                                                                                      | 5,663                     | 5,663                                                                 | 144,216                                                                 | 0.74%                                      |
|                                                                                                                                                                                                                                                      | 2,118                     | 10,074                                                                | 61,048                                                                  | 0.63%                                      |
|                                                                                                                                                                                                                                                      | 300                       | 300                                                                   | 22,196                                                                  | 0.11%                                      |
| Chart/figure understanding Chart2Text (Obeid and Hoque, 2020) DVQA (Kafle et al., 2018) VisText (Tang et al., 2023) ChartQA (Masry et al., 2022) PlotQA (Methani et al., 2020) FigureQA (Kahou et al., 2018) MapQA (Chang et al., 2022)              | 26,985                    | 30,242                                                                | 2,852,827                                                               | 4.38%                                      |
|                                                                                                                                                                                                                                                      | 200,000                   | 2,325,316                                                             | 8,346,234                                                               | 4.27%                                      |
|                                                                                                                                                                                                                                                      | 7,057                     | 9,969                                                                 | 1,245,485                                                               | 1.91%                                      |
|                                                                                                                                                                                                                                                      | 18,271                    | 28,299                                                                | 185,835                                                                 | 1.90%                                      |
|                                                                                                                                                                                                                                                      | 157,070                   | 20,249,479                                                            | 8478299.278                                                             | 0.65%                                      |
|                                                                                                                                                                                                                                                      | 100,000                   | 1,327,368                                                             | 3,982,104                                                               | 0.61%                                      |
|                                                                                                                                                                                                                                                      | 37,417                    | 483,416                                                               | 6,470,485                                                               | 0.33%                                      |
| Table understanding TabMWP (Lu et al., 2023) TAT-QA (Zhu et al., 2021) HiTab (Cheng et al., 2022) MultiHiertt (Zhao et al., 2022) FinQA (Chen et al., 2021) WikiSQL (Zhong et al., 2017) SQA (Iyyer et al., 2017) WTQ (Pasupat and Liang, 2015)      | 22,729                    | 23,059                                                                | 1,948,166                                                               | 2.49%                                      |
|                                                                                                                                                                                                                                                      | 2,199                     | 13,215                                                                | 283,776                                                                 | 2.18%                                      |
|                                                                                                                                                                                                                                                      | 2,500                     | 7,782                                                                 | 351,299                                                                 | 1.80%                                      |
|                                                                                                                                                                                                                                                      | 7,619                     | 7,830                                                                 | 267,615                                                                 | 1.37%                                      |
|                                                                                                                                                                                                                                                      | 5,276                     | 6,251                                                                 | 242,561                                                                 | 0.99%                                      |
|                                                                                                                                                                                                                                                      | 74,989                    | 86,202                                                                | 9,680,673                                                               | 0.99%                                      |
|                                                                                                                                                                                                                                                      | 8,514                     | 34,141                                                                | 1,894,824                                                               | 0.97%                                      |
|                                                                                                                                                                                                                                                      | 38,246                    | 44,096                                                                | 6,677,013                                                               | 0.51%                                      |
| Reasoning, logic, maths GeomVerse (Kazemi et al., 2024) CLEVR-Math (Lindström, 2022) CLEVR (Johnson et al., 2017) IconQA (Lu et al., 2021) RAVEN (Zhang et al., 2019) Inter-GPs (Lu et al., 2021)                                                    | 9,303                     | 9,339                                                                 | 2,489,459                                                               | 3.83%                                      |
|                                                                                                                                                                                                                                                      | 70,000                    | 788,650                                                               | 3,184,656                                                               | 3.26%                                      |
|                                                                                                                                                                                                                                                      | 70,000                    | 699,989                                                               | 2,396,781                                                               | 1.23%                                      |
|                                                                                                                                                                                                                                                      | 27,315                    | 29,859                                                                | 112,969                                                                 | 1.16%                                      |
|                                                                                                                                                                                                                                                      | 42,000                    | 42,000                                                                | 105,081                                                                 | 0.67%                                      |
|                                                                                                                                                                                                                                                      | 1,451                     | 2,101                                                                 | 8,404                                                                   | 0.17%                                      |
| Textbook/academic questions AI2D (Kembhavi et al., 2016) TQA (Kembhavi et al., 2017) ScienceQA (Lu et al., 2022)  Differences between 2 images                                                                                                       | 3,099                     | 9,708                                                                 | 38,832                                                                  | 0.80%                                      |
|                                                                                                                                                                                                                                                      | 1,496                     | 6,501                                                                 | 26,004                                                                  | 0.53%                                      |
|                                                                                                                                                                                                                                                      | 4,985                     | 6,218                                                                 | 24,872                                                                  | 0.25%                                      |
| NLVR2 (Suhr et al., 2019)<br>GSD (Li et al., 2023)<br>Spot the diff (Jhamtani et al., 2018)<br>Screenshot to code                                                                                                                                    | 50,426<br>70,939<br>8,566 | 86,373<br>141,869<br>9,524                                            | 259,119<br>4,637,229<br>221,477                                         | 1.33%<br>0.48%<br>0.57%                    |
| WebSight (Laurençon et al., 2024) DaTikz (Belouadi et al., 2024)                                                                                                                                                                                     | 500,000                   | 500,000                                                               | 276,743,299                                                             | 0.28%                                      |
|                                                                                                                                                                                                                                                      | 47,974                    | 48,296                                                                | 59,556,252                                                              | 0.03%                                      |
| Text-only general instructions, math pr<br>OpenHermes-2.5 (Teknium, 2023)<br>LIMA (Zhou et al., 2023)<br>Dolly (Conover et al., 2023)<br>MetaMathQA (Yu et al., 2024)<br>MathInstruct (Yue et al., 2024)                                             | oblems, ariti 0 0 0 0 0 0 | hmetic calculat<br>1,006,223<br>1,052<br>14,972<br>395,000<br>261,781 | ions<br>248,553,747<br>633,867<br>1,329,999<br>74,328,255<br>45,393,559 | 12.73%<br>0.81%<br>0.68%<br>3.81%<br>2.33% |

<sup>10</sup> https://huggingface.co/datasets/Kamizuru00/diagram\_image\_to\_text

| OrcaMath (Mitra et al., 2024) | 0 | 200,031    | 63,780,702  | 1.63% |
|-------------------------------|---|------------|-------------|-------|
| CamelAIMath (Li et al., 2023) | 0 | 49,744     | 21,873,629  | 0.06% |
| AtlasMathSets <sup>11</sup>   | 0 | 17,807,579 | 455,411,624 | 3.50% |
...
In the context of a red-teaming exercise, our objective is to evaluate the propensity of the model to generate inaccurate, biased, or offensive responses. We evaluate more specifically the chat-optimized checkpoint<sup>12</sup>.

<sup>11</sup> https://huggingface.co/datasets/AtlasUnified/atlas-math-sets

<sup>12</sup>https://huggingface.co/HuggingFaceM4/idefics2-8b-chatty

| Model           | Size | # tokens<br>per image | MMMU      | MathVista | TextVQA | MMBench | DocVQA | VQAv2 |
|-----------------|------|-----------------------|-----------|-----------|---------|---------|--------|-------|
| 7B-14B models   |      |                       |           |           |         |         |        |       |
