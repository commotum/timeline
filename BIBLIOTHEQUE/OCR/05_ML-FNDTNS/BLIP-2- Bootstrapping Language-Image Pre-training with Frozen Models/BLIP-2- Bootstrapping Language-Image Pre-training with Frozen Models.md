...
| Models                          | #Trainable<br>Params | Open-<br>sourced? | Visual Question Answering VQAv2 (test-dev) VQA acc. | 8     | Captioning<br>ps (val)<br>SPICE | 0    | ext Retrieval<br>kr (test)<br>IR@1 |
|---------------------------------|----------------------|-------------------|-----------------------------------------------------|-------|---------------------------------|------|------------------------------------|
| BLIP (Li et al., 2022)          | 583M                 | <b>√</b>          | -                                                   | 113.2 | 14.8                            | 96.7 | 86.7                               |
| SimVLM (Wang et al., 2021b)     | 1.4B                 | X                 | _                                                   | 112.2 | -                               | -    | -                                  |
| BEIT-3 (Wang et al., 2022b)     | 1.9B                 | X                 | _                                                   | -     | -                               | 94.9 | 81.5                               |
| Flamingo (Alayrac et al., 2022) | 10.2B                | X                 | 56.3                                                | -     | -                               | -    | -                                  |
| BLIP-2                          | 188M                 | <b>√</b>          | 65.0                                                | 121.6 | 15.8                            | 97.6 | 89.7                               |
...
| Models                             | #Trainable<br>Params | #Total<br>Params | VQAv2<br>val test-dev |      | OK-VQA<br>test | GQA<br>test-dev |
|------------------------------------|----------------------|------------------|-----------------------|------|----------------|-----------------|
...
| Models                                                                                                                                                                        | #Trainable<br>Params                           | in-do                             |                      | NoCaps Z<br>near-do<br>C         |                             | ot (valida<br>out-do<br>C        |                      | over<br>C                                | rall<br>S                   |                                                  | Fine-tuned athy test C                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|-----------------------------------|----------------------|----------------------------------|-----------------------------|----------------------------------|----------------------|------------------------------------------|-----------------------------|--------------------------------------------------|----------------------------------------------------|
| OSCAR (Li et al., 2020)<br>VinVL (Zhang et al., 2021)<br>BLIP (Li et al., 2022)<br>OFA (Wang et al., 2022a)<br>Flamingo (Alayrac et al., 2022)<br>SimVLM (Wang et al., 2021b) | 345M<br>345M<br>446M<br>930M<br>10.6B<br>~1.4B | 103.1<br>114.9<br>-<br>-<br>113.7 | 14.2<br>15.2         | 96.1<br>112.1<br>-<br>-<br>110.9 | 13.8<br>14.9                | 88.3<br>115.3<br>-<br>-<br>115.2 | 12.1<br>14.4<br>-    | 80.9<br>95.5<br>113.2<br>-<br>-<br>112.2 | 11.3<br>13.5<br>14.8        | 37.4<br>38.2<br>40.4<br><b>43.9</b><br>-<br>40.6 | 127.8<br>129.3<br>136.7<br>145.3<br>138.1<br>143.3 |
| BLIP-2 ViT-g OPT <sub>2.7B</sub><br>BLIP-2 ViT-g OPT <sub>6.7B</sub><br>BLIP-2 ViT-g FlanT5 <sub>XL</sub>                                                                     | 1.1B<br>1.1B<br>1.1B                           | 123.0<br>123.7<br>123.7           | 15.8<br>15.8<br>16.3 | 117.8<br>119.2<br>120.2          | 15.4<br>15.3<br><b>15.9</b> | 123.4<br>124.4<br><b>124.8</b>   | 15.1<br>14.8<br>15.1 | 119.7<br>121.0<br>121.6                  | 15.4<br>15.3<br><b>15.8</b> | 43.7<br>43.5<br>42.4                             | <b>145.8</b> 145.2 144.5                           |
...
|------------------------------|-----------------------------------|-------------|---------------------|-------|-------------|-------------------------------|------|------|-------------------|-------------|-------------|---------------------|-------------|
| Model                        | #Trainable<br>Params              | Im          | $age \rightarrow '$ | Text  | Te          | $xt \rightarrow In$           | nage | Im   | $age \rightarrow$ | Text        | Te          | $xt \rightarrow In$ | nage        |
|                              | raranis                           | R@1         | R@5                 | R@10  | R@1         | R@5                           | R@10 | R@1  | R@5               | R@10        | R@1         | R@5                 | R@10        |
| Dual-encoder models          |                                   |             |                     |       |             |                               |      |      |                   |             |             |                     |             |
...
| BEIT-3(Wang et al., 2022b)   | 1.9B                              | 94.9        | 99.9                | 100.0 | 81.5        | 95.6                          | 97.8 | 84.8 | <u>96.5</u>       | <u>98.3</u> | <u>67.2</u> | <b>87.7</b>         | 92.8        |
...
| <b>BLIP-2</b> ViT-g          | 1.2B                              | 97.6        | 100.0               | 100.0 | 89.7        | 98.1                          | 98.9 | 85.4 | 97.0              | 98.5        | 68.3        | <b>87.7</b>         | <u>92.6</u> |
...
| COCO finetuning objectives | Image<br>R@1 | $\rightarrow$ Text R@5 | Text –<br>R@1 | → Image<br>R@5 |
|----------------------------|--------------|------------------------|---------------|----------------|
...
| -                                      |                      |              |              |  |  |
|----------------------------------------|----------------------|--------------|--------------|--|--|
| LLM                                    | FlanT5 <sub>XL</sub> | $OPT_{2.7B}$ | $OPT_{6.7B}$ |  |  |
...
Information not up-to-date (this is iphone 14)

Figure 6. Incorrect output examples for instructed zero-shot image-to-text generation using a BLIP-2 model w/ ViT-g and FlanT5<sub>XXL</sub>.
