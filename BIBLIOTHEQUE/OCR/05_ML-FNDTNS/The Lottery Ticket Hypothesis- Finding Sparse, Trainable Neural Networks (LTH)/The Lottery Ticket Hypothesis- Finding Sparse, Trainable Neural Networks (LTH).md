...
- 2. Train the network for j iterations, arriving at parameters  $\theta_i$ .
...
| All/Conv Weight  | s 266K       | 4.3M / 38K    | 2.4M / 260K    | 1.7M / 1.1M    | 274K / 270K    | 20.0M                     |
| Iterations/Batch | 50K / 60     | 20K / 60      | 25K / 60       | 30K / 60       | 30K / 128      | 112K / 64                 |
| Optimizer        | Adam 1.2e-3  | Adam 2e-4     | Adam 3e-4      | Adam 3e-4      | ← SGD 0.1-0    | 0.01-0.001 Momentum 0.9 → |
...
<sup>&</sup>lt;sup>3</sup>Appendix H explores other hyperparameters, including learning rates, optimization strategies (SGD, momentum), and the relative rates at which to prune convolutional and fully-connected layers.
...
<sup>&</sup>lt;sup>4</sup>We choose new learning rates for the networks as trained with dropout—see Appendix H.5.
...
<sup>&</sup>lt;sup>5</sup>See Figure 2 and Appendices I for details on the networks, hyperparameters, and training regimes.
...
In this Subsection, we perform the lottery ticket experiment on the Conv-2, Conv-4, and Conv-6 architectures as optimized with Adam at various learning rates.
