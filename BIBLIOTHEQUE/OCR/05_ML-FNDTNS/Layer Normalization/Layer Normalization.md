...
Jimmy Lei Ba University of Toronto jimmy@psi.toronto.edu Jamie Ryan Kiros University of Toronto rkiros@cs.toronto.edu Geoffrey E. Hinton University of Toronto and Google Inc. hinton@cs.toronto.edu
...
$$\mathbb{E}[y \mid \mathbf{x}] = f(a+b) = f(w^{\mathsf{T}}\mathbf{x} + b), \quad \text{Var}[y \mid \mathbf{x}] = \phi f'(a+b), \tag{11}$$
...
<sup>&</sup>lt;sup>2</sup>https://github.com/cooijmanstim/Attentive\_reader/tree/bn

<sup>&</sup>lt;sup>3</sup>We only produce results on the validation set, as in the case of Cooijmans et al. [2016]
...
<sup>&</sup>lt;sup>5</sup>https://github.com/NVIDIA/cnmem
