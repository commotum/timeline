...
Alex  $Wang^1$ , Amanpreet  $Singh^1$ , Julian  $Michael^2$ , Felix  $Hill^3$ , Omer Levy $^2$  & Samuel R. Bowman $^1$ 
...
<sup>&</sup>lt;sup>2</sup>Paul G. Allen School of Computer Science & Engineering, University of Washington

<sup>&</sup>lt;sup>1</sup>To evaluate on the private test data, users of the benchmark must submit to gluebenchmark.com
...
<sup>&</sup>lt;sup>2</sup> data.quora.com/First-Quora-Dataset-Release-Question-Pairs

| Coarse-Grained Categories    | Fine-Grained Categories                                                                                                                                                                                                     |  |  |  |  |
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--|--|--|--|
| Lexical Semantics            | Lexical Entailment, Morphological Negation, Factivity,<br>Symmetry/Collectivity, Redundancy, Named Entities, Quantifiers                                                                                                    |  |  |  |  |
| Predicate-Argument Structure | Core Arguments, Prepositional Phrases, Ellipsis/Implicits,<br>Anaphora/Coreference Active/Passive, Nominalization,<br>Genitives/Partitives, Datives, Relative Clauses,<br>Coordination Scope, Intersectivity, Restrictivity |  |  |  |  |
...
<sup>&</sup>lt;sup>3</sup>An earlier release of QNLI had an artifact where the task could be modeled and solved as an easier task than we describe here. We have since released an updated version of QNLI that removes this possibility.

<sup>&</sup>lt;sup>4</sup>RTE4 is not publicly available, while RTE6 and RTE7 do not fit the standard NLI task.

| Tags                                                                      | Sentence 1                                                                         | Sentence 2                                                                                | Fwd | Bwd |  |
|---------------------------------------------------------------------------|------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-----|-----|--|
| Lexical Entailment (Lexi-<br>cal Semantics), Downward<br>Monotone (Logic) | The timing of the meeting has not been set, according to a Starbucks spokesperson. | The timing of the meeting has not been considered, according to a Starbucks spokesperson. | N   | Е   |  |
| Universal Quantifiers<br>(Logic)                                          | Our deepest sympathies are with all those affected by this accident.               | Our deepest sympathies are with a victim who was affected by this accident.               | Е   | N   |  |
| Quantifiers (Lexical Se-<br>mantics), Double Negation<br>(Logic)          | I have never seen a hummingbird not flying.                                        | I have never seen a hummingbird.                                                          | N   | Е   |  |
...
The GLUE benchmark follows the same evaluation model as SemEval and Kaggle. To evaluate a system on the benchmark, one must run the system on the provided test data for the tasks, then upload the results to the website <code>gluebenchmark.com</code> for scoring. The benchmark site shows per-task scores and a macro-average of those scores to determine a system's position on the leader-board. For tasks with multiple metrics (e.g., accuracy and F1), we use an unweighted average of the metrics as the score for the task when computing the overall macro-average. The website also provides fine- and coarse-grained results on the diagnostic dataset. See Appendix D for details.
...
<sup>&</sup>lt;sup>5</sup>See similar examples at cs.nyu.edu/faculty/davise/papers/WinogradSchemas/WS.html
...
To establish human baseline performance on the diagnostic set, we have six NLP researchers annotate 50 sentence pairs (100 entailment examples) randomly sampled from the diagnostic set. Interannotator agreement is high, with a Fleiss's  $\kappa$  of 0.73. The average  $R_3$  score among the annotators is 0.80, much higher than any of the baseline systems described in Section 5.
...
|                      |             | Single S    | Single Sentence Similarity and Paraphrase Na |                   |                   | Similarity and Paraphrase |                  |             | d Paraphrase Natural Language I |             |  |  |  |  |
|----------------------|-------------|-------------|----------------------------------------------|-------------------|-------------------|---------------------------|------------------|-------------|---------------------------------|-------------|--|--|--|--|
...
| +ELMo                | 66.4        | <u>35.0</u> | 90.2                                         | 69.0/80.8         | 85.7/65.6         | 64.0/60.2                 | 72.9/73.4        | 71.7        | 50.1                            | 65.1        |  |  |  |  |
| +CoVe                | 64.0        | 14.5        | 88.5                                         | 73.4/81.4         | 83.3/59.4         | 67.2/64.1                 | 64.5/64.8        | 75.4        | <u>53.5</u>                     | <u>65.1</u> |  |  |  |  |
| +Attn                | 63.9        | 15.7        | 85.9                                         | 68.5/80.3         | 83.5/62.9         | 59.3/55.8                 | 74.2/73.8        | 77.2        | 51.9                            | <u>65.1</u> |  |  |  |  |
| +Attn, ELMo          | 66.5        | <u>35.0</u> | 90.2                                         | 68.8/80.2         | <u>86.5/66.1</u>  | 55.5/52.5                 | <u>76.9/76.7</u> | 76.7        | 50.4                            | <u>65.1</u> |  |  |  |  |
| +Attn, CoVe          | 63.2        | 14.5        | 88.5                                         | 68.6/79.7         | 84.1/60.1         | 57.2/53.6                 | 71.6/71.5        | 74.5        | 52.7                            | <u>65.1</u> |  |  |  |  |
|                      |             |             |                                              | Multi-            | Task Trainin      | g                         |                  |             |                                 |             |  |  |  |  |
| BiLSTM               | 64.2        | 11.6        | 82.8                                         | 74.3/81.8         | 84.2/62.5         | 70.3/67.8                 | 65.4/66.1        | 74.6        | 57.4                            | 65.1        |  |  |  |  |
| +ELMo                | 67.7        | 32.1        | 89.3                                         | 78.0/84.7         | 82.6/61.1         | 67.2/67.9                 | 70.3/67.8        | 75.5        | 57.4                            | <u>65.1</u> |  |  |  |  |
| +CoVe                | 62.9        | 18.5        | 81.9                                         | 71.5/78.7         | <u>84.9</u> /60.6 | 64.4/62.7                 | 65.4/65.7        | 70.8        | 52.7                            | <u>65.1</u> |  |  |  |  |
| +Attn                | 65.6        | 18.6        | 83.0                                         | 76.2/83.9         | 82.4/60.1         | 72.8/70.5                 | 67.6/68.3        | 74.3        | 58.4                            | <u>65.1</u> |  |  |  |  |
| +Attn, ELMo          | <u>70.0</u> | 33.6        | <u>90.4</u>                                  | <b>78.0</b> /84.4 | 84.3/ <u>63.1</u> | 74.2/72.3                 | 74.1/74.5        | <u>79.8</u> | <u>58.9</u>                     | <u>65.1</u> |  |  |  |  |
| +Attn, CoVe          | 63.1        | 8.3         | 80.7                                         | 71.8/80.0         | 83.4/60.5         | 69.8/68.4                 | 68.1/68.6        | 72.9        | 56.0                            | <u>65.1</u> |  |  |  |  |
|                      |             |             | Pre-Tra                                      | ined Senten       | ce Represen       | tation Mode               | els              |             |                                 |             |  |  |  |  |
...
| GenSen               | <u>66.2</u> | <u>7.7</u>  | 83.1                                         | <u>76.6/83.0</u>  | <u>82.9/59.8</u>  | <u>79.3/79.2</u>          | <u>71.4/71.3</u> | <u>78.6</u> | <u>59.2</u>                     | 65.1        |  |  |  |  |
...
linear combination of the corresponding hidden states of each layer of the two models. We follow the authors' recommendations<sup>6</sup> and use ELMo embeddings in place of any other embeddings.
...
<sup>&</sup>lt;sup>6</sup>github.com/allenai/allennlp/blob/master/tutorials/how\_to/elmo.md
...
| +Attn, CoVe          | 24        | 29        | 29         | 18         | 12        | 77               | 50        | 1               | 18        | <u>-1</u>  | <u>12</u> |
| Multi-Task Training  |           |           |            |            |           |                  |           |                 |           |            |           |
| BiLSTM               | 20        | 13        | 24         | 14         | 22        | <u>71</u>        | 17        | -8              | 31        | -15        | 8         |
| +ELMo                | 21        | <u>20</u> | 21         | <u> 19</u> | 21        | <u>71</u>        | <u>60</u> | 2               | 22        | 0          | <u>12</u> |
| +CoVe                | 18        | 15        | 11         | 18         | <u>27</u> | 71               | 40        | <u>7</u>        | <u>40</u> | 0          | 8         |
| +Attn                | 18        | 13        | 24         | 11         | 16        | <u>71</u>        | 1         | -12             | 31        | -15        | 8         |
| +Attn, ELMo          | <u>22</u> | 18        | <u> 26</u> | 13         | 19        | 70               | 27        | 5               | 31        | -26        | -3        |
| +Attn, CoVe          | 18        | 16        | 25         | 16         | 13        | <u>71</u>        | 26        | -8              | 33        | 9          | 8         |
|                      |           | P         | re-Trai    | ned S      | ente      | nce Representati | on Mode   | ls              |           |            |           |
| CBoW                 | 9         | 6         | 13         | 5          | 10        | 3                | 0         | 13              | 28        | <u>-15</u> | -11       |
| Skip-Thought         | 12        | 2         | 23         | 11         | 9         | 61               | 6         | <u>13</u><br>-2 | <u>30</u> | -15        | 0         |
...
- Daniel Cer, Mona Diab, Eneko Agirre, Inigo Lopez-Gazpio, and Lucia Specia. Semeval-2017 task
   1: Semantic textual similarity-multilingual and cross-lingual focused evaluation. In *Eleventh International Workshop on Semantic Evaluations*, 2017.
...
- Allyson Ettinger, Sudha Rao, Hal Daumé III, and Emily M Bender. Towards linguistically generalizable NLP systems: A workshop and shared task. In *First Workshop on Building Linguistically Generalizable NLP Systems*, 2017.
...
- Tim Rocktäschel, Edward Grefenstette, Moritz Hermann, Karl, Tomáš Kočiskỳ, and Phil Blunsom. Reasoning about entailment with neural attention. In *Proceedings of the International Conference on Learning Representations*, 2016.
...
|                      | Single Sentence |      | Similar   | ity and Par | aphrase      | Natural Language Inference |      |      |      |      |  |
|----------------------|-----------------|------|-----------|-------------|--------------|----------------------------|------|------|------|------|--|
| Model                | Avg             | CoLA | SST-2     | MRPC        | QQP          | STS-B                      | MNLI | QNLI | RTE  | WNLI |  |
| Single-Task Training |                 |      |           |             |              |                            |      |      |      |      |  |
...
|                      |                 |      | Pre-Train | ned Sentenc | e Representa | ation Model                | s    |      |      |      |  |
...
- 1. CBoW, the average of the GloVe embeddings of the tokens in the sentence.
  - Skip-Thought (Kiros et al., 2015), a sequence-to-sequence(s) model trained to generate the
    previous and next sentences given the middle sentence. We use the original pre-trained
    model<sup>7</sup> trained on sequences of sentences from the Toronto Book Corpus (Zhu et al. 2015,
    TBC).
...
<sup>&</sup>lt;sup>7</sup>github.com/ryankiros/skip-thoughts

| PRIMARY          |                              |          |       |      | AUXILIARY |           |           |           |           |        |      |      |      |
|------------------|------------------------------|----------|-------|------|-----------|-----------|-----------|-----------|-----------|--------|------|------|------|
| RankName         | Model                        | URL      | Score | CoLA | SST-2     | MRPC      | STS-B     | QQP       | MNLI-m MI | ILI-mm | QNLI | RTE  | WNLI |
| 1 GLUE Baselines | BiLSTM+ELMo+Attn             | <b>♂</b> | 68.9  | 18.9 | 91.6      | 77.3/83.5 | 72.8/71.1 | 83.5/63.3 | 75.6      | 75.9   | 81.7 | 61.2 | 65.1 |
|                  | GenSen                       | <b>Z</b> | 66.6  | 7.7  | 83.1      | 76.6/83.0 | 79.3/79.2 | 82.9/59.8 | 71.4      | 71.3   | 82.3 | 59.2 | 65.1 |
|                  | Single Task BiLSTM+ELMo      | ď        | 66.2  | 35.0 | 90.2      | 69.0/80.8 | 64.0/60.2 | 85.7/65.6 | 72.9      | 73.4   | 69.4 | 50.1 | 65.1 |
|                  | BILSTM+Attn                  |          | 65.7  | 0.0  | 85.0      | 75.1/83.7 | 73.9/71.8 | 84.3/63.6 | 72.2      | 72.1   | 82.1 | 61.7 | 63.7 |
|                  | BiLSTM+ELMo                  | <b>♂</b> | 64.9  | 27.5 | 89.6      | 76.2/83.5 | 67.0/65.9 | 78.5/57.8 | 67.1      | 68.0   | 66.7 | 55.7 | 62.3 |
|                  | Single Task BiLSTM+ELMo+Attn | <b>♂</b> | 64.8  | 35.0 | 90.2      | 68.8/80.2 | 55.5/52.5 | 86.5/66.1 | 76.9      | 76.7   | 61.1 | 50.3 | 65.1 |
|                  | InferSent                    | <b>♂</b> | 64.7  | 4.5  | 85.1      | 74.1/81.2 | 75.9/75.3 | 81.7/59.1 | 66.1      | 65.7   | 79.8 | 58.0 | 65.1 |
|                  | BiLSTM+CoVe+Attn             | <b>♂</b> | 64.3  | 19.4 | 83.6      | 75.2/83.0 | 72.3/71.1 | 84.9/61.1 | 69.9      | 68.7   | 78.9 | 38.3 | 65.1 |
|                  | BiLSTM                       |          | 63.5  | 24.0 | 85.8      | 71.9/82.1 | 68.8/67.0 | 80.2/59.1 | 65.8      | 66.0   | 71.1 | 46.8 | 63.7 |
|                  | Single Task BiLSTM+CoVe      | <b>♂</b> | 62.4  | 14.5 | 88.5      | 73.4/81.4 | 67.2/64.1 | 83.3/59.4 | 64.5      | 64.8   | 64.8 | 53.5 | 61.6 |
|                  | BiLSTM+CoVe                  | <b>♂</b> | 62.2  | 16.2 | 84.3      | 71.8/80.0 | 68.0/67.1 | 82.0/59.1 | 65.3      | 65.9   | 70.4 | 44.2 | 65.1 |
|                  | DisSent                      | <b>♂</b> | 62.1  | 4.9  | 83.7      | 74.1/81.7 | 66.1/64.8 | 82.6/59.5 | 58.7      | 59.1   | 75.2 | 56.4 | 65.1 |
|                  | Single Task BiLSTM           |          | 62.0  | 15.7 | 85.9      | 69.3/79.4 | 66.0/62.8 | 81.7/61.4 | 70.3      | 70.8   | 60.8 | 52.8 | 62.3 |
|                  | Skip-Thought                 | <b>♂</b> | 61.5  | 0.0  | 81.8      | 71.7/80.8 | 71.8/69.7 | 82.2/56.4 | 62.9      | 62.8   | 74.7 | 53.1 | 65.1 |
|                  | Single Task BiLSTM+CoVe+Attn | <b>♂</b> | 60.8  | 14.5 | 88.5      | 68.6/79.7 | 57.2/53.6 | 84.1/60.1 | 71.6      | 71.5   | 53.8 | 52.7 | 64.4 |
...
- "Hummingbirds are really attracted to bright orange and red (hence why the feeders are usually these colours)" entails "The feeders are usually coloured so as to attract humming-birds".