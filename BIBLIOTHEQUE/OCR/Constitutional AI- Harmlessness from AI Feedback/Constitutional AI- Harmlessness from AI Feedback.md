...
- **1. CAI creates more harmless models with minimal impact on helpfulness.** Models trained using CAI learn to be less harmful at a given level of helpfulness.
- **2. CAI increases model transparency.** Encoding goals and objectives into AI systems in natural language increases the legibility of these systems. This enables users and regulators to peek into the "black box" of AI decision-making by making explicit the model's objectives and reasoning.
- **3. CAI is a scalable safety measure.** CAI is much less time- and resource-intensive than eliciting tens of thousands of human feedback labels. This means that it is both more efficient and it does not require exposing human crowdworkers to potentially offensive model outputs.
